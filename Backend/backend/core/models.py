...
class NominationHeaderSubmission(models.Model):
	...
	nodal_contact = models.CharField(max_length=50, blank=True)
	nodal_email = models.EmailField(blank=True)
	website_url = models.URLField(blank=True)
	institution_email = models.EmailField(blank=True)
	institution_phone = models.CharField(max_length=50, blank=True)
	...
	total_faculty = models.PositiveIntegerField(null=True, blank=True)
	created_at = models.DateTimeField(auto_now_add=True)
