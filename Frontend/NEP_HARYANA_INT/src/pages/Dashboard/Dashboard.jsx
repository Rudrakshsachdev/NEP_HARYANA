...
function Dashboard() {
  ...
  const menuItems = [
    ...
    },
    {
      ...
      icon: "M9 19v-6a2 2 0 012-2h2a2 2 0 012 2v6m-6 0h6M12 10a2 2 0 100-4 2 2 0 000 4z",
    },
    {
      title: "NEP Indicators",
              ...
              {showNotifDropdown && (
                <div className={styles.dropdownMenu}>
                  ...
                  <div className={styles.dropdownItem}>
                    New document request from State.
                  </div>
                  <div className={styles.dropdownItem}>
                    Your score was updated.
                  </div>
                  <div className={styles.dropdownItem}>
                    Deadline approaching: 31 May.
                  </div>
                </div>
              )}
            </div>
            ...
            <div className={styles.kpiGrid}>
              ...
              <div className={styles.kpiCard}>
                ...
                <div className={styles.kpiInfo}>
                  ...
                  <div className={styles.kpiValueRow}>
                    <h3>
                      612 <span className={styles.scoreMax}>/ 1000</span>
                    </h3>
              ...
              <div className={styles.chartCard}>
                ...
                <div className={styles.chartContainer}>
                  ...
                  <div className={styles.chartLegend}>
                    <div>
                      <span className={styles.legendBlue}></span> Your Score
                    </div>
                    <div>
                      <span className={styles.legendGray}></span> Max Score
                    </div>
                    <div>
                      <span className={styles.legendDotted}></span> State Avg
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className={styles.sideCardsGrid}>
                ...
                <div className={styles.scoreLevelCard}>
                  ...
                  <button
                    ...
                    onClick={() => setActiveMenu("Score & Evaluation")}
                  >
                ...
                <div className={styles.statusCard}>
                  ...
                  <button
                    ...
                    onClick={() => setActiveMenu("Documents Upload")}
                  >
                ...
                <div className={styles.tableWrapper}>
                  <table>
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td>
                          <div className={styles.progressCell}>
                            <div className={styles.progBar}>
                              <div
                                style={{ width: "80%", background: "#10b981" }}
                              ></div>
                            </div>
                            <span>80%</span>
                          </div>
                      ...
                      <tr>
                        ...
                        <td>
                          <div className={styles.progressCell}>
                            <div className={styles.progBar}>
                              <div
                                style={{ width: "55%", background: "#3b82f6" }}
                              ></div>
                            </div>
                            <span>55%</span>
                          </div>
                      ...
                      <tr>
                        <td>Student Support & Progress</td>
                        <td>12</td>
                        <td>8</td>
                        <td>4</td>
                        <td>100/200</td>
                      ...
                      <tr>
                        ...
                        <td>
                          <div className={styles.progressCell}>
                            <div className={styles.progBar}>
                              <div
                                style={{ width: "36%", background: "#ef4444" }}
                              ></div>
                            </div>
                            <span>36%</span>
                          </div>
                ...
                <div className={styles.activityCard}>
                  ...
                  <div className={styles.activityList}>
                    ...
                    <div className={styles.activityItem}>
                      ...
                      <div className={styles.activityInfo}>
                        <p>
                          Data updated in <strong>Faculty Information</strong>
                        </p>
                    ...
                    <div className={styles.activityItem}>
                      ...
                      <div className={styles.activityInfo}>
                        <p>
                          Document uploaded for{" "}
                          <strong>NEP Implementation</strong>
                        </p>
                ...
                <div className={styles.deadlinesCard}>
                  ...
                  <div className={styles.deadlineList}>
                    <div className={styles.deadlineItem}>
                      ...
                      <span
                        className={`${styles.deadlinePill} ${styles.redPill}`}
                      >
                        11 Days Left
                      </span>
                    </div>
                    <div className={styles.deadlineItem}>
                      ...
                      <span
                        className={`${styles.deadlinePill} ${styles.orangePill}`}
                      >
                        26 Days Left
                      </span>
                    </div>
                  ...
                  <div className={styles.aiList}>
                    <div className={styles.aiItem}>
                      ...
                      <div className={styles.aiContent}>
                        <p>
                          <strong>Improve Research Output:</strong> Increasing
                          publications in UGC care list by 15% could boost your
                          overall score by 25 points.
                        </p>
                    ...
                    <div className={styles.aiItem}>
                      ...
                      <div className={styles.aiContent}>
                        <p>
                          <strong>Pending Verification:</strong> 5 documents in
                          Student Support are pending. Complete them to avoid
                          score reduction.
                        </p>
