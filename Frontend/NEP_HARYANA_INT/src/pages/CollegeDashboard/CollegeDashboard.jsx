        ...
        <header className={styles.topNavbar}>
          ...
          <div className={styles.headerActions}>
            <div className={styles.searchBar}>
              ...
              <input type="text" placeholder="Search reports, files, people..." />
            ...
            <div className={styles.kpiGrid}>
              ...
              <div className={styles.kpiCard}>
                ...
                <div className={styles.kpiInfo}>
                  ...
                  <span className={styles.kpiSub}>Faculty and student data</span>
                </div>
              </div>
                    ...
                    <div className={styles.chartBarsArea}>
                      ...
                      <div className={styles.barGroup}>
                        <div className={styles.bars}>
                          <div className={styles.barBlue} style={{ height: "78%" }}>
                            <span>78</span>
                          </div>
                      ...
                      <div className={styles.barGroup}>
                        <div className={styles.bars}>
                          <div className={styles.barBlue} style={{ height: "68%" }}>
                            <span>68</span>
                          </div>
                          <div className={styles.barGray} style={{ height: "100%" }} />
                        </div>
                      ...
                      <div className={styles.barGroup}>
                        <div className={styles.bars}>
                          <div className={styles.barBlue} style={{ height: "86%" }}>
                            <span>86</span>
                          </div>
                          <div className={styles.barGray} style={{ height: "100%" }} />
                        </div>
                      ...
                      <div className={styles.barGroup}>
                        <div className={styles.bars}>
                          <div className={styles.barBlue} style={{ height: "64%" }}>
                            <span>64</span>
                          </div>
                          <div className={styles.barGray} style={{ height: "100%" }} />
                        </div>
                      ...
                      <div className={styles.barGroup}>
                        <div className={styles.bars}>
                          <div className={styles.barBlue} style={{ height: "72%" }}>
                            <span>72</span>
                          </div>
                          <div className={styles.barGray} style={{ height: "100%" }} />
                        </div>
                    ...
                    <tbody>
                        ...
                        <td>
                          <div className={styles.progressCell}>
                            <div className={styles.progBar}>
                              <div style={{ width: "86%", background: "#10b981" }} />
                            </div>
                            <span>86%</span>
                          </div>
                        </td>
                      ...
                      <tr>
                        ...
                        <td>
                          <div className={styles.progressCell}>
                            <div className={styles.progBar}>
                              <div style={{ width: "64%", background: "#f59e0b" }} />
                            </div>
                            <span>64%</span>
                          </div>
                        </td>
                    ...
                    <tfoot>
                      <tr>
                        ...
                        <td>
                          <div className={styles.progressCell}>
                            <div className={styles.progBar}>
                              <div style={{ width: "83%", background: "#2563eb" }} />
                            </div>
                            <span>83%</span>
                          </div>
                        </td>
                  ...
                  <div className={styles.activityList}>
                    <div className={styles.activityItem}>
                      ...
                      <div className={styles.activityInfo}>
                        <p>
                          Uploaded final proof for <strong>faculty verification</strong>
                        </p>
                    ...
                    <div className={styles.activityItem}>
                      ...
                      <div className={styles.activityInfo}>
                        <p>
                          Updated <strong>institution profile</strong> contact details
                        </p>
                  ...
                  <div className={styles.deadlineList}>
                    <div className={styles.deadlineItem}>
                      ...
                      <div className={styles.deadlineInfo}>
                        ...
                        <span className={styles.deadlineTime}>Due today, 5:00 PM</span>
                      </div>
                    </div>
                    <div className={styles.deadlineItem}>
          ...
          <div className={styles.analyticsGrid}>
            <div className={styles.chartCard}>
              ...
              <p style={{ color: "#64748b", lineHeight: 1.7, marginTop: 0 }}>
                This section is set up for the principal workflow. It can be expanded
                with action forms, approvals, and detailed records without changing
                the layout.
              </p>
              <div className={styles.kpiGrid}>
                <div className={styles.kpiCard}>
                  ...
                  <div className={styles.kpiInfo}>
                    <span>Next step</span>
                    <h3>Review data</h3>
                    <span className={styles.kpiSub}>Open pending records and verify changes.</span>
                  </div>
                </div>
                <div className={styles.kpiCard}>
                  <div className={`${styles.kpiIcon} ${styles.green}`}>
                  ...
                  <div className={styles.kpiInfo}>
                    <span>Status</span>
                    <h3>Ready</h3>
                    <span className={styles.kpiSub}>Principal dashboard shell is active.</span>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className={styles.sideCardsGrid}>
              <div className={styles.scoreLevelCard}>
                ...
                <p style={{ color: "#64748b", margin: 0, lineHeight: 1.7 }}>
                  Move back to the main dashboard, open compliance checks, or jump
                  into reports when you are ready.
                </p>
